...
export function MarketingServicesHero({ sx, ...other }) {
  ...
  return (
    <Box
      ...
      sx={{
        ...bgGradient({
          color: `to bottom, ${varAlpha(theme.vars.palette.common.blackChannel, 0)} 10%, ${theme.vars.palette.common.black} 75%`,
      ...
      <Container>
        ...
        >
          <Typography
            ...
            sx={{
              ...textGradient(
                `90deg, ${theme.vars.palette.info.main} 20%, ${theme.vars.palette.info.main} 100%`
              ),
              mb: 2,
              display: 'inline-flex',
              fontSize: 72,
          ...
          <Typography sx={{ opacity: 0.72, fontSize: 42 }}>Consultoria Tributária</Typography>
        </Box>
