...
import { filiaisCheckOutSummary } from '../checkout/filiais-check-out-summary';
import { filiaisCheckOutPaymentForm } from '../checkout/filiais-check-out-payment-form';
import { filiaisCheckOutShippingForm } from '../checkout/filiais-check-out-shipping-form';
...
export const filiaisCheckoutSchema = zod.object({
...
export function filiaisCheckoutView({ tour }) {
  ...
  const methods = useForm({
    resolver: zodResolver(filiaisCheckoutSchema),
    defaultValues,
  });
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      reset();
      router.push(paths.filiais.orderCompleted);
