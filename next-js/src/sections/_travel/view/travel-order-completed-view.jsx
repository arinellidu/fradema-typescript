...
import { filiaisOrderCompletedInfo } from '../order-completed/filiais-order-completed-info';
import { filiaisOrderCompletedSummary } from '../order-completed/filiais-order-completed-summary';

// ----------------------------------------------------------------------

export function filiaisOrderCompletedView({ tour }) {
  return (
    <Container
      sx={{
        display: 'grid',
