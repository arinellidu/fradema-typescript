...
export const _fullAddress = [
  `Rua México, 41 – 14º Andar – Centro, Cep: 20.031-144 – Rio de Janeiro – RJ`,
  ` Rua Iraúna, 405 – Moema
Cep: 04.518-060 – São Paulo – SP`,
  `Rua Eduardo Porto, 333 – Cidade Jardim
Cep: 30380-060 – Belo Horizonte – MG`,
  `Alameda Mongubas, 57 – Caminho das Árvores - Cep: 41.820-590 – Salvador – BA`,
  `Av Andrade Neves 1851 – Jardim Chapadão
Cep: 13.070-000 – Campinas- SP`,
  `SHIS QL 06, Conjunto 08-  Casa 11 – Lago Sul`,
...
export const _emails = [
  ...
  `frademasp@fradema.com.br`,
  `frademamg@fradema.com.br`,
  `frademaba@fradema.com.br`,
  `frademacampi@fradema.com.br`,
  `frademaes@fradema.com.br`,
