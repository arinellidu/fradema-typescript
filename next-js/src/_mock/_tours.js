...
const generateGallery = () => [...Array(6)].map((_, index) => _mock.image.filiais(index));

const generateHighlights = () => [...Array(6)].map((_, index) => _mock.sentence(index));

const generateHeroUrl = (index) =>
  [
    `${CONFIG.assetsDir}/assets/images/filiais/filiais-large-1.webp`,
    `${CONFIG.assetsDir}/assets/images/filiais/filiais-large-2.webp`,
    `${CONFIG.assetsDir}/assets/images/filiais/filiais-large-3.webp`,
    `${CONFIG.assetsDir}/assets/images/filiais/filiais-large-4.webp`,
    `${CONFIG.assetsDir}/assets/images/filiais/filiais-large-5.webp`,
  ][index];
