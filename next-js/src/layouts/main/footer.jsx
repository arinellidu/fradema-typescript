...
export function Footer({ layoutQuery, sx, ...other }) {
  ...
  const renderInfo = (
    <>
      ...
      <Typography variant="body2" sx={{ maxWidth: 360, color: 'text.secondary' }}>
        Cada projeto é único e tem seu início, meio e fim. Queremos fazer parte disso. A Fradema,
        encontra um meio!
      </Typography>
    </>
  );
  ...
  const renderSubscribe = (
    <>
      <div>
        ...
        >
          Receba as últimas novidades semanalmente por Email.
        </Typography>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        <Typography variant="caption"> Fradema Team © All rights reserved.</Typography>
