                ...
                >
                  <AnimateBorder
                    animate={{
                      duration: 12,
                      distance: 40,
                      color: [theme.vars.palette.info.main, theme.vars.palette.info.main],
                      outline: `135deg, ${varAlpha(theme.vars.palette.info.mainChannel, 0.04)}, ${varAlpha(theme.vars.palette.info.mainChannel, 0.04)}`,
                    }}
