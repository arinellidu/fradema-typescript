...
export const pageLinks = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Tours', path: paths.filiais.tours },
      { title: 'Tour', path: paths.filiais.tour },
      { title: 'Checkout', path: paths.filiais.checkout },
      { title: 'Order completed', path: paths.filiais.orderCompleted },
...
export const navData = [
  { title: 'Home', path: '/' },
  { title: 'filiais', path: paths.filiais.contact },
